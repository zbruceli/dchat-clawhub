...
export type MessageContentType = "text" | "textExtension" | "image" | "audio" | "file" | "receipt" | "read" | "contact" | "contactOptions";
...
export interface MessageOptions {
    ...
    ipfsIp?: string;
    ipfsEncrypt?: number;
    ipfsEncryptAlgorithm?: string;
    ipfsEncryptKeyBytes?: number[];
    ipfsEncryptNonceSize?: number;
